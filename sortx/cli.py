...
def main(
    ...
    stable: bool = typer.Option(
        True,
        "--stable/--unstable",
        help="Use stable sorting algorithm"
    ),
    unique: Optional[str] = typer.Option(
        None,
        "--unique",
        help="Column name for uniqueness constraint",
        metavar="COLUMN"
    ),
    ...
    natural: bool = typer.Option(
        False,
        "--natural",
        help="Use natural sorting for all string columns"
    ),
    stats: bool = typer.Option(
        False,
        "--stats",
        help="Show sorting statistics"
    ),
...
def show_examples() -> None:
    ...
    examples = [
        (
            ...
            "sortx sales.csv -o sorted.csv -k revenue:num"
        ),
        (
...
def show_data_types() -> None:
    ...
    types_table.add_row(
        "str",
        "String/text sorting",
        "name:str, category:str:locale=fr"
    )
    types_table.add_row(
        "num", 
        "Numeric sorting (int/float)",
        "price:num, age:num"
    )
    types_table.add_row(
        "date",
    ...
    types_table.add_row(
        "nat",
        "Natural sorting (file2 < file10)",
        "filename:nat, version:nat"
    )
